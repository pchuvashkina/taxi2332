...
const names = {
  ...
  orderModeManual: 'manual-mode.svg',
  orderModeRealistic: 'realistic-mode.svg',
  orderModeArrows: 'mode-arrows.svg',
  orderModeComplete: 'complete-icon.svg',
  orderModeCarIcon: 'toast-carIcon.svg',
